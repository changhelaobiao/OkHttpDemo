package com.lpx.okttpdemo.utils;
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                try {
                    ...
                    Logger.json(str);// 打印解析好的Json数据
                    // 个人还是喜欢这个写法，这样好加过滤条件，Android日志太多了，烦，将Json数据拷贝到网页进行在线解析
                    // 有一个问题就是当数据量过大的时候数据会拷贝补全，取一部分即可
                    Logger.d("------onResponse----->", "-----str--->" + str);
